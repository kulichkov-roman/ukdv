						...
						if ($showMapFlag):?>
							<td class="org-map-td">
								<div class="map-container">
									<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=-ys6OIYvtysf8mox47M2vt60SDUDHJSg&width=605&height=300&lang=ru_RU&sourceType=constructor&scroll=true"></script>
								</div>
							</td>
						<?endif?>
					</tr>
